"""
Django settings for kladbackend project.
...
SECRET_KEY = 'hvvgz=u3qy8%-uh$t=zz&+u8tmd=0_1e@2c#z)rmn^z#68&-5%'
...
WSGI_APPLICATION = 'kladbackend.wsgi.application'
